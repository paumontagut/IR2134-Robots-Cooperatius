...
2.8.0 (2025-07-21)
------------------
* Generate new cmd_id for stop request (`#294 <https://github.com/open-rmf/project/pull/294>`_)
...
2.6.0 (2025-05-09)
------------------
* Provide example of using reset planner cache setting (`#300 <https://github.com/open-rmf/project/issues/300>`_)
* Set self.teleoperation to None when finish_action (`#289 <https://github.com/open-rmf/project/issues/289>`_)
* Add Speed Limit Requests (`#152 <https://github.com/open-rmf/project/issues/152>`_)
* only remove if lane_idx exist in closed_lanes (`#276 <https://github.com/open-rmf/project/issues/276>`_)
